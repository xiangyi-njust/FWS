...
# scibet
os.system('python main.py --model bert --weight lordtt13//COVID-SCIBERT --batch_size 128 --path data//TypeClassify.xlsx --model_save_path weights//scibert// --isTrained True')
# textcnn
